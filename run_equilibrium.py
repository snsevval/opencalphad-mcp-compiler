...
elements_composition, temperature_K, and optionally pressure_Pa,
suspended_phases, dormant_phases, fixed_phases. Writes the JSON result to the output file
...
def main():
    ...
    try:
        result = oc_service.calculate_equilibrium(
            ...
            dormant_phases=args.get("dormant_phases"),
            fixed_phases=args.get("fixed_phases"),
        )
